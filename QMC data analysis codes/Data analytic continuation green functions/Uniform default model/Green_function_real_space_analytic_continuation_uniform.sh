...
for U in 5.10 5.20 5.30 5.40 5.50 5.60 5.70 5.75
do
   ...
   do
	...
	for trot_slices in $(seq 20 2 40)
        do
...
out_file=Spectral_function_real_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
out_file_back_cont=Retarded_green_function_back_continued_real_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
out_file_data=Analytic_continuation_data_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.h5
out_file_prob=Posterior_probabilities_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
out_file_class_max=Spectral_function_real_space_avg_classical_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
out_file_hist_max=Spectral_function_real_space_avg_historic_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_uniform_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
