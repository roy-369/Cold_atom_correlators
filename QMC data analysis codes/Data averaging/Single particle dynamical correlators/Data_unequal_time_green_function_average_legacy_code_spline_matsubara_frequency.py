...
def main(total,cmdargs):
    ...
    Text_dir_gf_r = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_real_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_real_space'%(N,N,U,Dtau,mu,Dtau,L)


    #==================== Directories for momentum space correlation averages ===================================================


    Text_dir_gf_k = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_momentum_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space'%(N,N,U,Dtau,mu,Dtau,L)

    Text_dir_gf_k_mf = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_momentum_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_matsubara_frequency'%(N,N,U,Dtau,mu,Dtau,L)
    ...
    Text_dir_gf_k_avg_ac = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_analytic_continuation/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_averaged'%(N,N,U,Dtau,mu,Dtau,L)



    Text_dir_gf_k_mf_avg_ac = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_analytic_continuation/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
    if not os.path.exists(Text_dir_gf_k_mf_avg_ac):
        os.makedirs(Text_dir_gf_k_mf_avg_ac)


    Text_dir_self_en_k_mf_avg_ac_v1 = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_analytic_continuation_self_energy_v1/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
    if not os.path.exists(Text_dir_self_en_k_mf_avg_ac_v1):
        os.makedirs(Text_dir_self_en_k_mf_avg_ac_v1)

    Text_dir_self_en_k_mf_avg_ac_v2 = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_analytic_continuation_self_energy_v2/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
    if not os.path.exists(Text_dir_self_en_k_mf_avg_ac_v2):
        os.makedirs(Text_dir_self_en_k_mf_avg_ac_v2)
        
    Text_dir_self_en_k_mf_avg_ac = '/fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Text_files/Text_files_N_%s_analytic_continuation_self_energy_avg_data/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
