...
def main(total,cmdargs):
    ...
    #===========================Directories for correlations for analytic continuation averages, imaginary time space =========================================
                ...
                Text_dir_gf_r_avg_ac = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_real_space_averaged'%(N,N,U,Dtau,mu,Dtau,L)
