...
do
   ...
   for Mu in 0.00 #$(seq 0.00 0.20 6.00)
   do
        cd Mu_${Mu} || exit

        for trot_slices in 20 22 24 26 28 30 32 34 36 38 40 42 44 46 48 50 52 54 56 58 60 
        do
               ...
               do
                  ...
                  do
                      ...
                      out_file=Spectral_function_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${Sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_back_cont=Retarded_green_function_back_continued_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${Sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      ...
                      out_file_class_max=Spectral_function_momentum_space_avg_classical_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${Sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_hist_max=Spectral_function_momentum_space_avg_historic_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${Sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
