   ...
   do
        ...
        do
            ...
            do
                  ...
                  mkdir -p Current_correlation_functions_analytic_continued_gaussian_sigma_${sig}_nfreq_${Freq}
                  cd Current_correlation_functions_analytic_continued_gaussian_sigma_${sig}_nfreq_${Freq} || exit
                  ...
                  do
                      ...
                      cp /fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Cold_atom_correlators/Data_processing_codes/Data_analytic_continuation_current_correlations/Gaussian_default_model/time_gaussian_temp.param ./time_gaussian.param
                      ...
                      out_file=Conductivity_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      
                      out_bose_file=Conductivity_momentum_space_avg_bosonic_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat

                      out_file_back_cont=Current_current_correlation_function_back_continued_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_data=Analytic_continuation_data_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.h5
                      out_file_prob=Posterior_probabilities_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_class_max=Conductivity_momentum_space_avg_classical_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat

                      out_bose_file_class_max=Conductivity_momentum_space_avg_bosonic_classical_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat

                      out_file_hist_max=Conductivity_momentum_space_avg_historic_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_gaussian_sigma_${sig}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
...
sed -i 's/ph_case/'$Ph_case'/g' ./time_gaussian.param
...
cp time_gaussian.out.avspec_bose.dat $out_bose_file
rm time_gaussian.out.avspec_bose.dat
...
cp time_gaussian.out.maxspec_bose.dat $out_bose_file_class_max
rm time_gaussian.out.maxspec_bose.dat
