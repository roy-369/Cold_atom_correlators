...
def main(total,cmdargs):
    ...
    U = "10.0"
    Trot = ["20","30","40","50","60","70","80"]

    Mu_10 = [["0.0000","1.0778","2.0202","2.8156","3.4986","4.0951","4.6484"],
             ["0.0000","1.4582","2.4092","3.0922","3.6542","4.1297","4.5706"],
             ["0.0000","1.7954","2.6340","3.2219","3.6974","4.1124","4.5014"],
             ["0.0000","2.0115","2.7464","3.2651","3.6974","4.0778","4.4409"],
             ["0.0000","2.1499","2.7983","3.2738","3.6801","4.0432","4.3804"],
             ["0.0000","2.2363","2.8329","3.2738","3.6542","4.0000","4.3372"],
             ["0.0000","2.2968","2.8501","3.2565","3.6282","3.9654","4.2939"]]

    target_den = ["1.00","1.05","1.10","1.15","1.20","1.25","1.30"]

    Text_dir_main = "../../Text_files_fixed_density"

    for k in range(len(Trot)):
        L = Trot[k]
        for j in range(len(target_den)):

            mu = Mu_10[k][j]

    #==========================Diretories for real space correlation averages =============================================

            Text_dir_gf_r = '../../../Text_files_fixed_density/Text_files_N_%s_real_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_real_space'%(N,N,U,Dtau,mu,Dtau,L)

    #==================== Directories for momentum space correlation averages ===================================================

            Text_dir_gf_k = '../../../Text_files_fixed_density/Text_files_N_%s_momentum_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space'%(N,N,U,Dtau,mu,Dtau,L)

            Text_dir_gf_k_mf = '../../../Text_files_fixed_density/Text_files_N_%s_momentum_space_correlations/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_matsubara_frequency'%(N,N,U,Dtau,mu,Dtau,L)
     ...
     #===========================Directories for correlations for analytic continuation averages, matsubara frequency space =========================================
            ...
            Text_dir_gf_k_avg_ac = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_averaged'%(N,N,U,Dtau,mu,Dtau,L)

            Text_dir_gf_k_mf_avg_ac = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Retarded_green_functions_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
            if not os.path.exists(Text_dir_gf_k_mf_avg_ac):
               os.makedirs(Text_dir_gf_k_mf_avg_ac)


            Text_dir_self_en_k_mf_avg_ac_v1 = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation_self_energy_v1/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
            if not os.path.exists(Text_dir_self_en_k_mf_avg_ac_v1):
               os.makedirs(Text_dir_self_en_k_mf_avg_ac_v1)

            Text_dir_self_en_k_mf_avg_ac_v2 = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation_self_energy_v2/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
            if not os.path.exists(Text_dir_self_en_k_mf_avg_ac_v2):
               os.makedirs(Text_dir_self_en_k_mf_avg_ac_v2)
        
            Text_dir_self_en_k_mf_avg_ac = '../../../Text_files_fixed_density/Text_files_N_%s_analytic_continuation_self_energy_avg_data/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Self_energy_momentum_space_matsubara_frequency_averaged'%(N,N,U,Dtau,mu,Dtau,L)
            if not os.path.exists(Text_dir_self_en_k_mf_avg_ac):
               os.makedirs(Text_dir_self_en_k_mf_avg_ac)

            Text_dir_eqm = "../../../Text_files_fixed_density/Text_files_N_%s/Text_files_N_%s_U_%s_dtau_%s/Mu_%s/dtau_%s_L_%s/Thermodynamic_measurements"%(N,N,U,Dtau,mu,Dtau,L)
