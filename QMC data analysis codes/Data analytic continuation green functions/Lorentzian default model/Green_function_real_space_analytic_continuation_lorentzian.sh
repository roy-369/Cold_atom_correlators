...
do
   ...
   do
	...
	for trot_slices in $(seq 18 2 60)
        do
               ...
               do
                  ...
                  do
                      ...
                      out_file=Spectral_function_real_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_back_cont=Retarded_green_function_back_continued_real_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_data=Analytic_continuation_data_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.h5
                      out_file_prob=Posterior_probabilities_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_class_max=Spectral_function_real_space_avg_classical_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
                      out_file_hist_max=Spectral_function_real_space_avg_historic_mxnt_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_r_label_${rlab}_lorentzian_gamma_${Gam}_nfreq_${Freq}_omega_max_${omega_max}_omega_min_${omega_min}.dat
