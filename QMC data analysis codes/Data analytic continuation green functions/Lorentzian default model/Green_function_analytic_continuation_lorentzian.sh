...
cd /fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Data_Luttinger_Breaking/Text_files/Text_files_N_${N}_analytic_continuation

for U in 5.0
do
   cd Text_files_N_${N}_U_${U}_dtau_${dt} || exit 

   for Mu in $(seq 0.20 0.20 2.00)
   do
        ...
        do
               ...
               do
                  ...
                  do
                      ...
                      cp /fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Data_Luttinger_Breaking/Text_files/Text_files_N_${N}_analytic_continuation/Text_files_N_${N}_U_${U}_dtau_${dt}/Mu_${Mu}/dtau_${dt}_L_${trot_slices}/Retarded_green_functions_momentum_space_averaged/Retarded_Green_function_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}.dat ./Retarded_Green_function_momentum_space_avg_N_${N}_U_${U}_mu_${Mu}_dtau_${dt}_L_${trot_slices}_k_label_${klab}_ac.dat
                      cp /fs/byo/trivedi/roy.369/Research/Determinant_Quantum_Monte_Carlo/UC_code/legacy-qmc/Data_Luttinger_Breaking/Data_processing_codes/Data_analytic_continuation_green_functions/Lorentzian_default_model/time_lorentzian_temp.param ./time_lorentzian.param
